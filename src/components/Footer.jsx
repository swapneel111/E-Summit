  ...
  return (
    <div className={`${show ? 'footer-container' : 'footer-container hidden'}`}>
      <div className="social-icons">
        <a className="social-link" href="https://www.instagram.com/bengalesummit?igsh=MWt6bjAwcTNuMzJyYg==">
        ...
        <a className="social-link" href="https://www.facebook.com/profile.php?id=61560898934811&mibextid=ZbWKwL">
          <svg fill="#FFFFFF" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a className="social-link" href="https://x.com/BengalEsummit?t=LLrSXFuhlzBoWCcRQX4uPg&s=09">
          <svg fill="#FFFFFF" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a className="social-link" href="https://www.linkedin.com/in/bengal-e-summit-32394b315?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
          <svg fill="#FFFFFF" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
